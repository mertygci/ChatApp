<div class="user-chat w-100 overflow-hidden">
    <div class="d-lg-flex">
        <div class="w-100 overflow-hidden position-relative">
                    ...
                    <div class="col-sm-4 col-8">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                                <h5 class="font-size-16 mb-0 text-truncate"><a href="#" class="text-reset user-profile-show">{{$selectedUser->name??null}}</a> <i class="ri-record-circle-fill font-size-10 text-success d-inline-block ms-1"></i></h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="chat-conversation p-3 p-lg-4" style="overflow: auto" data-simplebar="init">
                <ul class="list-unstyled mb-0">
                    @if($selectedUserId)

                        @foreach($messages as $key => $message)
                    <li class="{{ $message->from_user_id == auth()->id() ? 'right' : 'left' }}">
            ...
            <div class="chat-input-section p-3 p-lg-4 border-top mb-0">
                ...
                <div class="row g-0">
                    ...
                    <div class="col">
                        <input type="text" wire:model="newMessage" wire:keydown.enter="sendMessage" class="form-control form-control-lg bg-light border-light" placeholder="Enter Message...">
                    </div>
                    <div class="col-auto">
                        <div class="chat-input-links ms-md-2 me-md-0">
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <button wire:click="sendMessage" type="submit" class="btn btn-primary font-size-16 btn-lg chat-send waves-effect waves-light">
